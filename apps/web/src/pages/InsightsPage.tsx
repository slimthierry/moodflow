...
import { useInsightReports, useGenerateInsight } from '@moodflow/api-client';
import { InsightCard } from '@moodflow/ui';
import type { CorrelationData, TrendData, RecommendationItem } from '@moodflow/types';
